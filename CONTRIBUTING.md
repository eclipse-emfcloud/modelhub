# Contributing to Eclipse EMF Cloud ModelHub

Thank you for your interest in the EMF Cloud ModelHub project!
...
* [GitHub issues](https://github.com/eclipse-emfcloud/modelhub/issues) - for project wide bug reports, feature requests, etc.
...
In the commit message you should also reference the corresponding issue, e.g. using `closes #115` / `closes https://github.com/eclipse-emfcloud/modelhub/issues/115`, thus allowing [auto close of issues](https://help.github.com/en/github/managing-your-work-on-github/closing-issues-using-keywords).
